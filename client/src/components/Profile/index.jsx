...
import { cancelOrder,API_URL } from '../../utils/APIRoutes';
...
export default function Profile() {
    ...
    const handleCancelOrder = async (orderId) => {
        ...
        try {
            const response = await axios.delete(cancelOrder, {
    ...
    useEffect(() => {
        const fetchOrderData = async () => {
            try {
                ...
                const response = await fetch(`${API_URL}/api/order/getdata/${userID}`);
