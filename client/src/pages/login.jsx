...
export default function Login() {
  ...
  const handleSubmit = async (values, { setSubmitting, setErrors }) => {
    try {
      ...
      if (response.data.success) {
        ...
        if (user.isAdmin) {
          setIsAdmin(true);
          navigate("/admin/dashboard"); // Redirect to admin page if user is admin
        } else {
          navigate("/"); 
  ...
  return (
    ...
    sx={{
      ...
      alignItems: "center",
      height: "100vh",
      backgroundImage: "url('/Desktop.jpeg')", // Set your background image here
    ...
    >
      <Card sx={{ maxWidth: 345, minWidth: 345, minHeight: 400,
                backgroundColor: "rgba(255, 255, 255, 0.9)",boxShadow: 4, // Soft shadow effect
